    ...
    getProvider() {
        if (!this._baseAlchemyProvider) {
            this._baseAlchemyProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyProvider } = yield Promise.resolve().then(function () { return require('./alchemy-provider-35615bdb.js'); });
    ...
    getWebSocketProvider() {
        if (!this._baseAlchemyWssProvider) {
            this._baseAlchemyWssProvider = (() => __awaiter$1(this, void 0, void 0, function* () {
                const { AlchemyWebSocketProvider } = yield Promise.resolve().then(function () { return require('./alchemy-websocket-provider-002a5adb.js'); });
...
function parseOpenSeaMetadata(openSea) {
    ...
    return {
        ...
        safelistRequestStatus: openSea.safelistRequestStatus !== undefined
            ? stringToEnum(openSea.safelistRequestStatus, exports.OpenSeaSafelistRequestStatus)
            : undefined,
        ...
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            if (utils.isHexString(blockIdentifier, 32)) {
                ...
                const block = typeof blockIdentifier === 'number'
                    ? utils.hexValue(blockIdentifier)
                    : blockIdentifier;
...
function getNftMetadata(config, contractAddress, tokenId, options, srcMethod = 'getNftMetadata') {
    return __awaiter$1(this, void 0, void 0, function* () {
        const response = yield requestHttpWithBackoff(config, AlchemyApiType.NFT, 'getNFTMetadata', srcMethod, {
            ...
            tokenType: (options === null || options === void 0 ? void 0 : options.tokenType) !== exports.NftTokenType.UNKNOWN
                ? options === null || options === void 0 ? void 0 : options.tokenType
                : undefined,
...
function getNftsForTransfers(config, response) {
    return __awaiter$1(this, void 0, void 0, function* () {
        ...
        const nfts = yield getNftMetadataBatch(config, metadataTransfers.map(transfer => transfer.token));
        const transferredNfts = nfts.map((nft, i) => (Object.assign(Object.assign({}, nft), metadataTransfers[i].metadata)));
        return {
        ...
        return __awaiter$1(this, void 0, void 0, function* () {
            ...
            if (type === exports.WebhookType.NFT_ACTIVITY) {
                ...
                network = params.network
                    ...
                    : network;
                filters = params.filters.map(filter => filter.tokenId
                    ? {
...
//# sourceMappingURL=index-be872a1f.js.map
